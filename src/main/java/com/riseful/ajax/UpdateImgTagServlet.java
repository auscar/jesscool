...
public class UpdateImgTagServlet extends HttpServlet {
	/**
	 * 
	 */
	...
	public void doGet(HttpServletRequest req, HttpServletResponse res){
		...
		String imgTagName = req.getParameter("imgTagName");
		
		//创建ImgTag对象封装数据
		ImgTag imgTag = new ImgTag();
		imgTag.setImgTagId(imgTagId);
		imgTag.setImgTagName(imgTagName);
		
		//更新数据库
		service.imgTagUpdate(imgTag);
